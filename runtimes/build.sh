...
echo 'Deno 1.13...'
docker buildx build --platform linux/amd64,linux/arm/v6,linux/arm/v7,linux/arm64,linux/386,linux/ppc64le -t appwrite/runtime-for-deno:1.13.2 ./runtimes/deno-1.13/ --push
