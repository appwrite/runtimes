...
class Runtimes
{
    ...
    public function __construct()
    {
        ...
        $deno->addVersion('1.8', 'hayd/deno:alpine-1.8.2', 'appwrite/runtime-for-deno:1.8', [System::X86]);
        ...
        $java->addVersion('11', 'openjdk/11-jre', 'appwrite/runtime-for-kotlin:11', [System::X86]);
        $java->addVersion('16', 'openjdk/16-jdk-alpine', 'appwrite/runtime-for-kotlin:16', [System::X86]);
